          ...
          <div className="container relative">
            <div className="text-center space-y-12">
              ...
              <p className="text-xl font-light text-brown-700 max-w-4xl mx-auto leading-relaxed">
                Experience the difference with Brisbane's most trusted property specialists. We guide you through every
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              ...
              <Card className="border border-brown-100 hover:shadow-xl transition-all duration-500">
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-brown-700 font-light leading-relaxed">
                    Track record of successful purchases with satisfied clients across Brisbane's premium suburbs.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border border-brown-100 hover:shadow-xl transition-all duration-500">
                <CardContent className="p-8 text-center">
                  ...
                  <h3 className="text-xl font-light text-brown-900 mb-4">Time Saving</h3>
                  <p className="text-brown-700 font-light leading-relaxed">
                    We handle the research, inspections, and paperwork, saving you valuable time and effort.
                  </p>
                </CardContent>
              </Card>
