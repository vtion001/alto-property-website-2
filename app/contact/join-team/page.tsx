  ...
  const benefits = [
    {
      icon: TrendingUp,
      title: "Career Growth",
      description: "Structured career progression with ongoing training and development opportunities.",
    },
    {
      icon: Award,
      title: "Industry Recognition",
      description: "Work with an award-winning team recognized for excellence in property services.",
    },
    {
      icon: Users,
      title: "Supportive Culture",
      description: "Join a collaborative team that values genuine care and professional excellence.",
    },
    {
      icon: Heart,
      title: "Work-Life Balance",
      description: "Flexible working arrangements and a culture that values personal wellbeing.",
    },
  ]
