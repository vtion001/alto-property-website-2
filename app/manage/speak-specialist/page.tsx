                  ...
                  <div className="space-y-8">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-brown-700">(07) 3000 0000</p>
                        <p className="text-brown-600 text-sm">Monday - Friday: 8:30am - 5:30pm</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-brown-700">info@altopropertygroup.com.au</p>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-brown-700">Level 5, 123 Queen Street</p>
                        <p className="text-brown-700">Brisbane QLD 4000</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-brown-700">Monday - Friday: 8:30am - 5:30pm</p>
                ...
                <Card className="border border-brown-200 bg-brown-50">
                  <CardContent className="p-8">
                    <div className="text-center space-y-4">
                      ...
                      <p className="text-brown-700 font-medium text-lg">(07) 3000 0001</p>
