...
import { TrendingUp, Users, Award, Home, Calculator, FileText } from "lucide-react"
              ...
              <div className="space-y-12">
                <div className="space-y-8">
                  <div className="inline-block">
                    <div className="text-xs tracking-[0.3em] text-brown-600 uppercase mb-2">Property Sales</div>
                  ...
                  <h1 className="text-6xl font-extralight tracking-tight sm:text-7xl lg:text-8xl text-brown-800 leading-none">
                    ...
                    <span className="block font-extralight text-brown-600 mt-2">With Confidence</span>
                  </h1>
                  <p className="text-xl font-light text-brown-700 max-w-xl leading-relaxed">
                    Achieve exceptional results with our proven sales process. We combine market expertise with
                    personalized service to maximize your property's value.
                  </p>
                </div>
        ...
        <section className="py-32 bg-white">
          <div className="container">
            <div className="text-center space-y-8 mb-24">
              <div className="inline-block">
                <div className="text-xs tracking-[0.3em] text-brown-600 uppercase mb-2">Selling Services</div>
                <div className="w-16 h-px bg-brown-300 mx-auto"></div>
              </div>
              <h2 className="text-5xl font-extralight sm:text-6xl text-brown-800">Complete Selling Solutions</h2>
            </div>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              <Card className="group hover:shadow-xl transition-all duration-500 border border-brown-100">
                <CardHeader>
                  ...
                  <CardTitle className="text-xl text-brown-900 font-light">Free Property Report</CardTitle>
              ...
              <Card className="group hover:shadow-xl transition-all duration-500 border border-brown-100">
                <CardHeader>
                  ...
                  <CardTitle className="text-xl text-brown-900 font-light">Recently Sold</CardTitle>
                  <CardDescription className="text-brown-700 font-light">
              ...
              <Card className="group hover:shadow-xl transition-all duration-500 border border-brown-100">
                <CardHeader>
                  ...
                  <CardTitle className="text-xl text-brown-900 font-light">Selling Guide</CardTitle>
                  <CardDescription className="text-brown-700 font-light">
        ...
        <section className="py-24 bg-gradient-to-br from-brown-50 to-stone-50">
          <div className="container">
            <div className="text-center space-y-8 mb-16">
              <h2 className="text-4xl font-light sm:text-5xl text-brown-800">Why Sell With Alto</h2>
            </div>
            <div className="grid gap-8 md:grid-cols-3">
              <div className="text-center space-y-4">
                ...
                <h3 className="text-xl font-light text-brown-900">Premium Results</h3>
                <p className="text-brown-700 font-light">Consistently achieving above-market prices for our clients.</p>
              </div>
              <div className="text-center space-y-4">
                <div className="bg-brown-100 w-20 h-20 rounded-full flex items-center justify-center mx-auto">
                  <Users className="h-10 w-10 text-brown-700" />
                </div>
                <h3 className="text-xl font-light text-brown-900">Expert Team</h3>
                <p className="text-brown-700 font-light">Experienced agents with deep local market knowledge.</p>
              </div>
              <div className="text-center space-y-4">
                <div className="bg-brown-100 w-20 h-20 rounded-full flex items-center justify-center mx-auto">
                  <Award className="h-10 w-10 text-brown-700" />
                </div>
                <h3 className="text-xl font-light text-brown-900">Award Winning</h3>
                <p className="text-brown-700 font-light">Recognized excellence in property sales and service.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-24 bg-brown-900 text-cream">
          <div className="container text-center">
            <div className="space-y-10 max-w-4xl mx-auto">
              <h2 className="text-4xl font-light sm:text-5xl">Ready to Sell Your Property?</h2>
              <p className="text-xl text-brown-100 leading-relaxed">
                Get started with a free property appraisal and discover your property's true market value.
              </p>
              <Button
                size="lg"
                variant="secondary"
