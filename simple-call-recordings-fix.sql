-- Simple Fix for Call Recordings Table
...
-- Create RLS policy for call_recordings (allow all operations)
DROP POLICY IF EXISTS "Allow all operations on call_recordings" ON public.call_recordings;
